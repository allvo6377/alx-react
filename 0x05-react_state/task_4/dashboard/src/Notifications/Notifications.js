        ...
        {this.props.displayDrawer ? 
          (<div className={css(styles.notifStyle)} id='Notifications'>
            ...
            <ul className={css(styles.ulStyle)}>
              ...
              {this.props.listNotifications.map((notif) => (<NotificationItem key={notif.id} type={notif.type} value={notif.value} html={notif.html} markAsRead={this.props.markNotificationAsRead}/>))}
            </ul>
          </div>)
          : <></>}
      </div>
